...
<div class="wrapper"> 
    <div class="content">
        ...
        <div class="taxi-home-join-network"><br>
            ...
            <div class="home-div-3">
                <button class="all-purpose-btn" style="background-color: #e8b122; color: black;" onclick="location.href='<?php echo URLROOT?>/Request/addGuideRequest'">Request a guide</button>
            </div><br>
        </div>
